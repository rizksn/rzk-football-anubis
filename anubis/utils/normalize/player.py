from .name import normalize_name_for_display, normalize_name_for_matching
...
def normalize_player_fields(player: dict) -> dict:
    player["full_name"] = normalize_name_for_display(player.get("full_name", ""))
    player["search_full_name"] = normalize_name_for_matching(player["full_name"])
